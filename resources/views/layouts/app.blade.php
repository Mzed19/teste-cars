...
<html class="loading" lang="pt" data-textdirection="ltr">
  ...
  <!-- BEGIN: Body-->
  <body class="bg-app vertical-layout vertical-menu-modern navbar-floating footer-static pace-done menu-expanded" data-open="click" data-menu="vertical-menu-modern" data-col="">
    <div id="app">
